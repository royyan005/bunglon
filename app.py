...
if choose == "Aksara":
    ...
    with col1:               # To display the header text using css style
        ...
        font-size:35px ; font-family: 'Cooper Black'; color: #FF9633;} p {text-align: center;} 
        </style> """, unsafe_allow_html=True)
        st.markdown('<p class="font">AKSARA LAMPUNG</p>', unsafe_allow_html=True)    
         
        st.markdown('<style>body {background-color: #f5f5f5;} p {text-align: justify;}</style>', unsafe_allow_html=True)
...
if choose == "Tentang":
    ...
    with col1:               # To display the header text using css style
        ...
        st.markdown(""" <style> .font {
        font-size:30px ; font-family: 'Cooper Black'; color: #FF9633; p {text-align: justify;}} 
        </style> """, unsafe_allow_html=True)
    ...
    with st.form(key="search form"):
        ...
        search_term = st.text_input("Masukan teks anda disini")
